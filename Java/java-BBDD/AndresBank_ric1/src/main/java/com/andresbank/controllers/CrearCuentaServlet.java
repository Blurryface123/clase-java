	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getSession().getAttribute("dni") != null) {
			...
			try {
				...
				int newCid = CuentaDAO.getInstance().crearCuenta(newCuenta, miCliente); // este metodo es el que ejecuta los demás métodos y para toda la cuenta
				//los metodos creados en cuentaDAO ejecutan metodos especificos para cada página.
